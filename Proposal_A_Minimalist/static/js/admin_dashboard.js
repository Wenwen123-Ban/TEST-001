...
let editModal;
    ...
    async function loadData(resetFilter = false) {
        ...
        masterBooks = [
            { book_no: 'BK-101', title: 'Modern Web UI', category: 'Technology', status: 'Available' },
            { book_no: 'BK-102', title: 'Library Systems', category: 'General', status: 'Available' },
            { book_no: 'BK-103', title: 'Design Principles', category: 'Design', status: 'Available' },
            { book_no: 'BK-104', title: 'Data Structures', category: 'Computer Science', status: 'Available' }
        ];
        masterUsers = [];
        masterAdmins = [];
        masterTransactions = [];
        masterCategories = ['Technology', 'General', 'Design', 'Computer Science'];
        masterApprovalRecords = [];
        masterRegistrationRequests = [
            { request_id: 'REQ-001', student_name: 'Alex Rivera', school_id: '2026-001', status: 'Pending' },
            { request_id: 'REQ-002', student_name: 'Bianca Cruz', school_id: '2026-002', status: 'Pending' },
            { request_id: 'REQ-003', student_name: 'Carlo Gomez', school_id: '2026-003', status: 'Pending' }
        ];
        masterCourses = [];

        setConnectionStatus(true, 'Static Mock Mode');
